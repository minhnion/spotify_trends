...
from spark_jobs.utils.spark_session_k8s_streaming import create_spark_session_k8s


spark = SparkSession.builder.appName("spark-kafka-minio").getOrCreate()
...
# ======================================================
df = spark.read.parquet("s3a://spotify-processed-data/features_5m/part-*.parquet")
...
# ======================================================
daily_df = daily_df.repartition(1, "date")
